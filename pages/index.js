...
export default function Example() {
  return (
    <div className="min-h-screen bg-slate-800 text-indigo-500">
      ...
      <div className="relative bg-gray-800 py-32 px-6 sm:py-40 sm:px-12 lg:px-16">
        ...
        <div className="relative max-w-3xl mx-auto flex flex-col items-center text-center">
          <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">I nostri servizi</h2>
          <ul className="mt-3 text-xl text-white">
            <li>Movimento Terra</li>
            <li>Sistemazione verde pubblico</li>
            <li>Lavori Edili e Stradali c/o terzi</li>
          </ul>
